...
<head>
    ...
    <title><?php echo xlt("Mensajes"); ?></title>
...
<body class="skin-blue">
    ...
    <ng ng-app="emrMessageApp">
        <div class="container-fluid" id='main' style="display: none">
            <div class='my-3'>
                <h2><i class='fa fa-envelope w-auto h-auto mr-2'></i><?php echo xlt('Mensajes'); ?></h2>
            </div>
                ...
                <div class="col-md-2 p-0 m-0 text-left border-right bg-secondary">
                    <div class="sticky-top">
                        <ul class="nav nav-pills nav-stacked flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="pill" href="javascript:;" ng-click="isSentSelected()"><span class="badge float-right">{{sentItems.length}}</span><?php echo xlt('Enviados{{Mails}}'); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="pill" href="javascript:;" ng-click="isAllSelected()"><span class="badge float-right">{{allItems.length}}</span><?php echo xlt('Todos{{Mails}}'); ?></a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="col-12 mb-2">
                            ...
                            <div class="btn-group btn-group float-right">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li>
                                        <a class="dropdown-item" href="javascript:;" ng-click="readAll()"><?php echo xlt('Marcar todos como leídos'); ?></a>
                                    </li>
                                    <li class="dropdown-divider"></li>
                                    <li>
                                        <a class="dropdown-item" href="" data-mode="add" data-toggle="modal" data-target="#modalCompose"><i class="fa fa-edit"></i><?php echo xlt('Nuevo mensaje'); ?></a>
                                    </li>
                                    <li ng-show='!isTrash'>
                                        <a class="dropdown-item" href="javascript:;" ng-click="batchDelete(items)"><i class="fa fa-trash"></i><?php echo xlt('Enviar seleccionado al archivo'); ?></a></li>
                                    <li>
